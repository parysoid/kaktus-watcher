...
const KAKTUS_URL = process.env.KAKTUS_URL ? process.env.KAKTUS_URL:"https://www.mujkaktus.cz/chces-pridat";
const KAKTUS_HREF_TARGET_URL = process.env.KAKTUS_HREF_TARGET_URL ? process.env.KAKTUS_HREF_TARGET_URL:"https://www.mujkaktus.cz/dobit-kredit";
